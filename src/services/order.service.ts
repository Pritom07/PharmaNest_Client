...
export const orderServices = {
  ...
  getRecentOrders: async function () {
    try {
      const cookieStore = await cookies();
      const res = await fetch(`${BACKEND_URL}/api/customer/orders/recent`, {
        headers: {
          Cookie: cookieStore.toString(),
        },
      });
  ...
  getSellerEndOrders: async function () {
    try {
      const cookieStore = await cookies();
      const res = await fetch(`${BACKEND_URL}/api/customer/orders/sellerEnd`, {
        headers: {
          Cookie: cookieStore.toString(),
        },
      });
  ...
  getOrderById: async function (id: string) {
    try {
      const cookieStore = await cookies();
      const res = await fetch(`${BACKEND_URL}/api/customer/order/${id}`, {
        headers: {
          Cookie: cookieStore.toString(),
        },
      });
  ...
  getStatsForAdmin: async function () {
    try {
      const cookieStore = await cookies();
      const res = await fetch(`${BACKEND_URL}/api/customer/stats/adminEnd`, {
        headers: {
          Cookie: cookieStore.toString(),
        },
      });
  ...
  get_Last_FiveDays_Orders_For_Admin: async function () {
    try {
      const cookieStore = await cookies();
      const res = await fetch(
        `${BACKEND_URL}/api/customer/lastFiveDaysOrders/adminEnd`,
        {
          headers: {
            Cookie: cookieStore.toString(),
          },
  ...
  //     // const url = new URL(
  //     //   `https://pharmanest-server.vercel.app/api/customer/getOrderStats/adminEnd`,
  //     // );
